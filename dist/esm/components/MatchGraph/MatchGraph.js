...
const MatchGraph = (props) => {
    ...
    if (typeof window === 'undefined')
        return null;
    const { name } = props;
    const match = (_a = lexer.getProperty(name)) !== null && _a !== void 0 ? _a : lexer.getType(name); // FIXME: check property or type
    if (match === null)
        return null;
    ...
    return React.createElement("div", { className: "view-match-graph" },
        React.createElement(MatchGraphConnectionMarker, null),
        React.createElement("div", { className: "canvas", ref: ref => {
                if ((ref === null || ref === void 0 ? void 0 : ref.childElementCount) === 0) {
                    ref.append(matchTreeConnectionsEl, matchTreeEl);
                }
            } }));
};
const MatchGraphConnectionMarker = () => (React.createElement("svg", { style: { position: 'absolute', zIndex: -1, width: 0, height: 0 } },
    React.createElement("marker", { id: "match-graph-connection-marker", viewBox: "0 0 5 10", refX: "0", refY: "5", markerUnits: "strokeWidth", markerWidth: "6", markerHeight: "4", orient: "auto" },
        React.createElement("path", { d: "M 0 0 L 10 5 L 0 10 z", fill: "rgba(160, 160, 160, 0.65)" }))));
